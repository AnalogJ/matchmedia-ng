    ...
    angular.module("matchmedia-ng", []).
         ...
         *  }]);
            ...
            matchmedia.$get = ['$window','safeApply', 'logger', function($window, safeApply, logger) {
                ...
                /**
                 * @type {boolean} true if the browser supports matchmedia.
                 */
                matchmediaService.supportsMatchMedia = ($window.matchMedia !== undefined);
                /**
                 * @type {boolean} true if the browser supports matchmedia listeners. Compatible with IE9, IE10, IE11.
                 */
                matchmediaService.supportsMatchMediaListener = ($window.matchMedia !== undefined && !!$window.matchMedia('only screen').addListener);
                ...
                matchmediaService.on = function(query, listener, $scope) {
                    if (matchmediaService.supportsMatchMediaListener) {
                        ...
                        return function() {
                            // listeners not supported, so this is a NOP
                            logger.log('listener not supported, nothing to unregister');
                        }
                    }
                };
                /**
